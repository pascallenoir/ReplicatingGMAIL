...
namespace ReplicatingGMAIL.Controls
{
    ...
    public partial class ExpandParagraphControl : ContentView
    {
        ...
        public static readonly BindableProperty ExpandedButtonTitleProperty = BindableProperty.Create(nameof(ExpandedButtonTitle), typeof(string), typeof(ExpandParagraphControl), defaultValue: "Réduire");
